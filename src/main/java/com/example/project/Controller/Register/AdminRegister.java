package com.example.project.Controller.Register;
...
public class AdminRegister {
    ...
    void createNewUser(ActionEvent event) throws SQLException {
        ...
        User user=new User(username1,password1,firstname1,lastname1,age1,email1,phone1,gender1,"admin");
        user.save();
    ...
    void showLoginPage(ActionEvent event) throws IOException {
        ...
        ViewManager.closeAdminRegister();
    }
    public void reset(){
        username.setText("");
        password.setText("");
